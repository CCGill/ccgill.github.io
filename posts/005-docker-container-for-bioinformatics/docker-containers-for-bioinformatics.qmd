...
This post is intended to give a short practical example of using two key tools to install bioinformatics tools and use them.  Both conda and docker are widely used.  I have used conda for a little under a decade and got started with docker a few years ago, but I can see that containerization is more and more widely used.  Hopefully this post can serve as a practical example for those getting started with these approaches. 
...
5. Once you have a working environment that you can carry out your analysis in, don't forget to export the environment yaml file.  This is necessary to ensure you can recreate the environment yourself.
```{bash}
#| eval: false
